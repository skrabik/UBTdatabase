...
/**
 * Инициализация таблиц RBAC.
 */
class m240228_000002_rbac_init extends Migration
{
    protected function getAuthManager(): DbManager
    {
        $authManager = Yii::$app->getAuthManager();
        if (!$authManager instanceof DbManager) {
            throw new InvalidConfigException('Настройте компонент "authManager" с DbManager для выполнения миграции.');
        }
        return $authManager;
    }
